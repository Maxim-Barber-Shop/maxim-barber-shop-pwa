    ...
    <div className="min-h-[calc(100vh-153px)] bg-background">
      <main className="container mx-auto px-4 py-4">
        <div className="mb-4">
          ...
          <p className="text-sm text-muted-foreground">Panoramica economica e statistiche</p>
        </div>
        ...
        {statistics && (
          <>
            ...
            <div className="mb-4 grid gap-2 grid-cols-2">
              <Card>
                <CardContent className="p-2">
                  ...
                  <p className="text-xs text-muted-foreground">€{statistics.averageRevenuePerAppointment.toFixed(2)}</p>
                </CardContent>
              </Card>
            ...
            <div className="mb-4 grid gap-2 md:grid-cols-2">
              ...
              <Card>
                <CardHeader className="p-2">
                  <CardTitle className="text-xs font-semibold">Fatturato per Barbiere</CardTitle>
                </CardHeader>
                <CardContent className="p-0">
                  <div className="divide-y">
                    {statistics.revenueByBarber.length === 0 ? (
                      <div className="py-4 text-center text-xs text-muted-foreground">Nessun dato</div>
                    ) : (
                      statistics.revenueByBarber.map((barber) => (
                        <div key={barber.barberId} className="flex items-center justify-between px-2 py-1.5">
                          <div className="min-w-0 flex-1">
                            <p className="truncate text-xs font-medium">{barber.barberName}</p>
                            <p className="text-xs text-muted-foreground">{barber.appointments} app.</p>
                          </div>
                          <div className="text-right">
                            <p className="text-xs font-bold">€{barber.revenue.toFixed(2)}</p>
                            <p className="text-xs text-muted-foreground">
              ...
              {selectedStore === 'all' && (
                <Card>
                  <CardHeader className="p-2">
                    <CardTitle className="text-xs font-semibold">Fatturato per Sede</CardTitle>
                  </CardHeader>
                  <CardContent className="p-0">
                    <div className="divide-y">
                        ...
                        statistics.revenueByStore.map((store) => (
                          <div key={store.storeId} className="flex items-center justify-between px-2 py-1.5">
                            <div className="min-w-0 flex-1">
                              ...
                              <p className="text-xs text-muted-foreground">{store.appointments} app.</p>
                            </div>
                            <div className="text-right">
                              <p className="text-xs font-bold">€{store.revenue.toFixed(2)}</p>
                              <p className="text-xs text-muted-foreground">
            ...
            <Card>
              <CardHeader className="p-2">
                <CardTitle className="text-xs font-semibold">Dettaglio Stati</CardTitle>
              </CardHeader>
              <CardContent className="p-2">
