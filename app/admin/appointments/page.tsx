...
import { ChevronLeft, ChevronRight, Clock, MapPin, User, Phone, Plus, Pencil, Trash2 } from 'lucide-react';
...
function AdminAppointmentsContent() {
  ...
  const getAppointmentsForDate = (date: Date | null) => {
    ...
    return appointments.filter((apt) => {
      ...
      const matchesViewMode = viewMode === 'all' || apt.barber.id === user?.id;
      ...
      <main className="container mx-auto px-4 py-4">
        ...
        <div className="mb-6 flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Select value={viewMode} onValueChange={(value: 'all' | 'mine') => setViewMode(value)}>
                      ...
                      <CardHeader>
                        <div className="flex items-start justify-between">
                          ...
                          <div className="text-right">
                            <div className="text-base font-semibold">€{appointment.service.price.toFixed(2)}</div>
